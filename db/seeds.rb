...
coins = Coin.create([
  ...
  { name: 'Cardano', description: 'Cardano is a blockchain platform that aims to be a decentralized application (DApp) development platform with a multi-asset ledger and verifiable smart contracts. 4. Cardano is being built in five stages: foundation, decentralization, smart contracts, scaling, and governance.', picture:"https://cryptologos.cc/logos/cardano-ada-logo.png" },
